import {
  ...
  createStore,
  useStore
} from "./chunk-D7IP32TD.js";
import {
  require_jsx_runtime
} from "./chunk-RSZRHCXG.js";
import {
  require_react
} from "./chunk-WD4VQBVD.js";
import {
  __privateAdd,
  __privateGet,
  __privateSet,
...
var FormApi = class {
  ...
  constructor(opts) {
    ...
    this.reset = (values, opts2) => {
      ...
      this.baseStore.setState(() => {
        var _a2;
        let nextValues = values ?? this.options.defaultValues ?? ((_a2 = this.options.defaultState) == null ? void 0 : _a2.values);
        if (!values) {
    ...
    this.resetField = (field) => {
      this.baseStore.setState((prev) => {
        var _a2;
        const fieldDefault = (_a2 = this.getFieldInfo(field).instance) == null ? void 0 : _a2.options.defaultValue;
  ...
  constructor(opts) {
    ...
    this.mount = () => {
      ...
      return () => {
        ...
        this.form.baseStore.setState((prev) => {
          ...
          return {
            ...
            fieldMetaBase: {
              ...
              [this.name]: {
                ...defaultFieldMeta,
                isTouched: ((_a3 = prev.fieldMetaBase[this.name]) == null ? void 0 : _a3.isTouched) ?? defaultFieldMeta.isTouched,
        ...
        (_b2 = (_a2 = this.options.listeners) == null ? void 0 : _a2.onUnmount) == null ? void 0 : _b2.call(_a2, {
          value: this.state.value,
          fieldApi: this
        });
      ...
      const validateFieldAsyncFn = (field, validateObj, promises) => {
        ...
        promises.push(
          new Promise(async (resolve) => {
            ...
            const formLevelError = (_a = asyncFormValidationResults[field.name]) == null ? void 0 : _a[errorMapKey];
            const { newErrorValue, newSource } = determineFieldLevelErrorSourceAndValue({
              formLevelError,
              fieldLevelError
            });
  ...
  function useAppForm(props) {
    ...
    const AppField = (0, import_react6.useMemo)(() => {
      const AppField2 = (({ children, ...props2 }) => {
        return (0, import_jsx_runtime4.jsx)(form.Field, { ...props2, children: (field) => (0, import_jsx_runtime4.jsx)(fieldContext2.Provider, { value: field, children: children(Object.assign(field, fieldComponents)) }) });
      });
      return AppField2;
    }, [form]);
