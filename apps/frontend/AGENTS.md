...
**Regola:** Quando installi un pacchetto, usa SEMPRE l'ultima versione. `npm view react version` → usa `^<version>`.

**Esempio:** `react` latest 19.2.6 → `"react": "^19.2.6"` in `package.json`.
